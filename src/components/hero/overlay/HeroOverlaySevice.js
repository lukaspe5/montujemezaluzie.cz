...
export const HeroOverlayService = withTheme(({active, theme}) => {
            ...
            <div className='heroOverlay'>
                <div className="heroOverlay__wrapper">
                    ...
                    <div className='heroOverlay__linkButtonWrapper'>
                        <Link
                            to={NavBarLinks.find(navBarLink => navBarLink.name === SectionName.SERVICES).href}
                            smooth={true}
                            offset={-100}
                        >
                            <Button variant="contained" color='secondary' className='heroOverlay__linkButton'>Naše
                                služby</Button>
                        </Link>
                    </div>
                </div>
